...
import { createDanaAction } from "../../redux/action/paymentAction";
...
function PaymentDana() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      if (
        ...
        dispatch(await createDanaAction(values, navigate));
      }
    },
  });
  ...
  return (
    <>
      <TopNewNav path={`/payment/${id}`} title="Payment Dana" />
            ...
            <div className="payment-container">
              <div className="payment-content">
                ...
                <div className="cantainer-option-payment-f">
                  <BankContent image={dana} title={`Dana`} border={false} />
