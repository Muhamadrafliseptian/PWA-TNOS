...
function DetailRiwayatTransaksi() {
  TitleHeader("Detail Riwayat Transaksi");
  ...
  const getDataOrder = async () => {
    ...
    setLoader(true);
    const url = `${process.env.REACT_APP_API_PWA}/order/${params.id}`;
  ...
  var renderDetailLayanan = () => {
    if (layanan === "1") {
      ...
      } else if (sublayanan === "7") {
        nama_layanan = "Solusi Hukum";
