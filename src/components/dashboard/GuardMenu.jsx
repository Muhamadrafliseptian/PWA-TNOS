...
// import iconGuard from "../../assets/images/icon-guard.svg";
  ...
  return (
    <div className="responsive-class">
      <div className="res-class">
        ...
        <div className={`box-content-guard-menu-adn ${fullsize ? "hide" : ""}`}>
          <div className={`box-show-hide-sj ${fullsize ? "hide" : ""}`}>
            <div className="detail-location-jsan">
              ...
              <p className="p-detail-lokasi-sj">
                Jl. Sultan Iskandar Muda No. 100 C, RT.05/RW.4, Kby. Lama Utara,
            ...
            <div className="jam-bertugas-sj text-center">
              <h5 className="title-jam-bertugas-sj">
                <FaClock /> Pilih jam bertugas :
              </h5>
              <div className="btn-group mb-3">
                <button className="btn-jam-bertugas-sj">18.00</button>
                <button className="btn-jam-bertugas-sj">19.00</button>
                <button className="btn-jam-bertugas-sj active">20.00</button>
              </div>
