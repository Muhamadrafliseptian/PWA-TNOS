...
function FormTransactionPendampinganMenu() {
  ...
  const onSubmitOrder = async (e) => {
    ...
    await axios
      .post("http://127.0.0.1:8000/api/pendampingan/in-order", data)
      .then((res) => {
        console.log(res);
        setLoader(false);
        if (res.data.error) {
        ...
        navigate(
          `/form-transaksi-detail-pendampingan-hukum/` + res.data.detail.id
        );
      })
      .catch((res) => {
        console.log(res);
          ...
          <div className="njwdjhwk">
            <div className="row">
              <div className="col-lg-8 col-md-8 col-sm-8 col-xl-8 col-12">
                <h5 className="title-kasnadkw">Pendampingan hukum</h5>
                <p className="text-justify jjdw">
                  Mitra Advokat terpercaya, siap siaga 24 jam memberikan advice
                  terkait permasalahan hukum baik itu dalam pelaporan hukum dan
                  pemeriksaan di kepolisian.
                </p>
              </div>
              <div className="col-lg-4 col-md-4 col-sm-4 col-xl-4 col-12">
                <img src={pf} alt="" className="img-xy" />
              </div>
            </div>
            <hr />
            <ToastContainer
            ...
            <form onSubmit={(e) => onSubmitOrder(e)}>
              ...
              <div className="form-group mb-2">
                <label htmlFor="time">*Pilih waktu pendampingan :</label>
                <input
                  type="datetime-local"
                  name="time"
                  className={`form-control form-layanan ${
...
export default FormTransactionPendampinganMenu;
