...
function FormTransactionDetailPeroranganMenu() {
  ...
  const getDataOrder = async () => {
    ...
    await axios
      .get(
        `http://127.0.0.1:8000/api/pengamanan-perorang/get-detail-order/${params.id}`
      )
      .then((res) => {
  ...
  const onSubmitOrder = async (e) => {
    ...
    try {
      ...
      setLoader(true);
      await axios
        .post("http://127.0.0.1:8000/api/pengamanan-perorang/in-payment", data)
        .then((res) => {
          setLoader(false);
          console.log(res);
          // window.open(
        ...
        <div className="res-class">
          ...
          <div className="njwdjhwk">
            <h5 className="title-kasnadkw">
              Order Detail Pengamanan Perorang : {params.id}{" "}
            </h5>
            <hr />
            <ToastContainer
              position="bottom-right"
            ...
            <form onSubmit={(e) => onSubmitOrder(e)}>
              <div className="form-group mb-2">
                <label htmlFor="keperluan">*Keperluan pengamanan</label>
                <textarea
                  name="keperluan"
                  id="keperluan"
                  cols="10"
              ...
              <div className="form-group mb-2">
                <label htmlFor="waktu_konsul">*Pilih waktu pengamanan :</label>
                <input
                  type="text"
                  name="waktu_konsul"
                  value={time}
...
export default FormTransactionDetailPeroranganMenu;
