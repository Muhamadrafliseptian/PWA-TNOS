            ...
            <div className="flexcol">
                { searchParams?.mitra === "Trigger" ?
                  <div className="flexbox">
                   ...
                   <Button onClick={() => navigate(`/corporate-security-m/${searchParams.mitra}?query=${getP}`)} style={{ backgroundColor:'#E3E8ED', border: 0 }}> <ArrowForward style={{ color:'#777777', fontSize:'18px', fontWeight:600 }}/> </Button>
                  </div>
                  :
                  <div className="flexbox">
                    <div style={{ display: 'flex', flexDirection: 'row' }}>
