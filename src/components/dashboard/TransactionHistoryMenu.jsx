...
function TransactionHistoryMenu() {
  ...
  //   return rand.toLocaleString(undefined, { maximumFractionDigits: 2 });
  // };

  const getDataByDay = async () => {
    const url = `${process.env.REACT_APP_API_PWA}/history/${user.mmbr_code}`;
          ...
          <div className="history-wjdwn mt-3">
            ...
            {layananId
                ...
                row.games
                  ...
                  .map((row, key) => {
                    ...
                    if (
                      ...
                      name = "Yayasan";
                      icon = cv;
                      url = `/badan-hukum-yayasan/${row.id}`;
                    } else if (
                      row.tnos_service_id === "3" &&
                      ...
                      <Fragment key={key}>
                        <div className="d-flex align-items-center justify-content-between mb-2 dawd">
                          ...
                          <div className="ndwdwdwajdw">
                            ...
                            <div onClick={() => navigate(url)} className="klik">
                              Lanjutkan membayar
                            </div>
                          </div>
                        </div>
              ...
              : row.games.map((row, key) => {
                  ...
                  var url;
                  var status_order = "";
                  var css_status_order = { background: "rgb(90 255 110 / 0%)" };
                      ...
                      <div className="d-flex align-items-center justify-content-between mb-2 dawd">
                        <div className="d-flex align-items-center">
                          ...
                          <div className="profil-ndwadnj">
                            ...
                            <span className="kkn-sf" style={css_status_order}>
                              Status Pembayaran:{" "}
                              <b className="kkn-sf" style={css_payment_status}>
                                {payment_status}
                              </b>
                            </span>
                            <br />
