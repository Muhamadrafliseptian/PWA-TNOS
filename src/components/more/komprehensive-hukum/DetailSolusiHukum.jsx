...
function DetailSolusiHukum() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      // const encryptDataInvoice = CryptoJS.AES.encrypt(detail_data_layanan.invoice_id, keyCrpyto).toString();
  ...
  return (
    <>
      <TopNewNav title="Ringkasan" path={"/comprehensive-Legal-solutions"} />
