            ...
            <div className="flexcol">
                ...
                <div className="flexbox">
                    <div style={{ display: 'flex', flexDirection: 'row' }}>
                      ...
                      <span style={{ alignSelf: 'center', marginLeft: '24px' }}>LAINNYA</span>
                    </div>
              ...
              <div className="container-class">
                <div className="responsive-class">
                    ...
                    <div style={{ display:'flex', flexDirection:'row', alignItems:'center', justifyContent:'center'}}>
                      ...
                      />
                      <span style={{ fontWeight:600, marginLeft: '24px' }} >{drawerOpen?.mitra === 'Trigger' ? "TRIGER": (drawerOpen?.mitra === "PAS" ? "PAS" : "LAINNYA" ) }</span>
                    </div>
                    <div style={{ padding: '22px', fontSize:'14px', textAlign:'justify' }}>
                      ...
                      <button onClick={() => {navigate(`/services-list-m/${drawerOpen?.mitra}?query=${getP}`); setDrawerOpen({open: false, mitra: ''}) }} style={{ padding: '8px 10px', justifyContent:'center', alignItems:'center', borderRadius:'4px', backgroundColor:'#F99F1B', border:0, color: 'white', fontWeight:'600px', width: '100%' }} >Lanjut</button>
                    </div>
                </div>
              </div>
            </Drawer>
