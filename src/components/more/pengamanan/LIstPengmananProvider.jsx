...
function ListPengamananProvider() {
  ...
  return (
    <>
      <TopNewNav title={t("sublayanan8")} path={`/dashboard`} />
              ...
              <div className="container-class">
                <div className="responsive-class">
                    ...
                    <div style={{ display:'flex', flexDirection:'row', alignItems:'center', justifyContent:'center'}}>
                      ...
                      />
                      <span style={{ fontWeight:600, marginLeft: '24px' }} >{drawerOpen?.mitra === 'Trigger' ? t("partner2"): (drawerOpen?.mitra === "PAS" ? t("partner1") : t("partner3") ) }</span>
                    </div>
