...
import { ptSchema } from "../../utils/formSchema";
...
function BadanPt() {
  ...
  const options = [
    { value: "4", label: "PERORANGAN" },
    { value: "3", label: "START UP" },
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      // console.log(values);
      dispatch(await badanHukumCreate(values, navigate, "/pt/checkout/"));
    },
    validationSchema: ptSchema,
  });
  ...
  // console.log(formik.values.bidang_usaha.length);

  return (
    <>
      <TopNewNav
        title="Pembuatan Badan Hukum PT"
                  ...
                  <form action="">
                    ...
                    <div className="form-group mb-2">
                      ...
                      <InputSelectComponent
                        ...
                        onChange={formik.setFieldValue}
                        onBlur={formik.setFieldTouched}
                        value={formik.values.klasifikasi.label}
                        id="klasifikasi"
                      />
                      {formik.errors.klasifikasi &&
                        formik.touched.klasifikasi ? (
                        <TextError error={formik.errors.klasifikasi} />
                      ) : (
                        ""
                      )}
                    </div>
      ...
      <ModalComponent
        ...
        type="kententuan"
      >
        <KetentuanComponentNew type="Badan Usaha PT" />
      </ModalComponent>
    </>
  );
}

export default BadanPt;
