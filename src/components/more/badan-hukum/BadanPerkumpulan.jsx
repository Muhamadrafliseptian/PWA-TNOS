...
import { perkumpulanSchema } from "../../utils/formSchema";
...
function BadanPerkumpulan() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      console.log(values);
      dispatch(
        await badanHukumCreate(values, navigate, "/association/checkout/")
      );
    },
    validationSchema: perkumpulanSchema,
  });
  ...
  return (
    <>
      <TopNewNav
        title="Pembuatan Legalitas Perkumpulan"
                  ...
                  <form action="">
                    ...
                    <div className="form-group mb-2">
                      <LabelComponent
                        ...
                        label="Nama Perkumpulan (opsi pertama)"
                      />
                      <InputComponent
                        type={"text"}
                    ...
                    <div className="form-group mb-2">
                      <LabelComponent
                        ...
                        label="Nama Perkumpulan (opsi kedua)"
                      />
                      <InputComponent
                        id="name_badan_hukum2"
                    ...
                    <div className="form-group mb-2">
                      <LabelComponent
                        ...
                        label="Nama Perkumpulan (opsi ketiga)"
                      />
                      <InputComponent
                        id="name_badan_hukum3"
                    ...
                    <hr />
                    <b className="title-layanan-f">Domisili Perkumpulan</b>
                    <Gap height={10} />
                    <div className="form-group mb-2">
                      <LabelComponent
                    ...
                    <div className="form-group mb-2">
                      <LabelComponent label="Email Perkumpulan & Password" />
                      <InputComponent
                        type={"text"}
      ...
      <ModalComponent
        ...
        type="kententuan"
      >
        <KetentuanComponentNew type="Badan Hukum Perkumpulan" />
      </ModalComponent>
    </>
  );
}

export default BadanPerkumpulan;
