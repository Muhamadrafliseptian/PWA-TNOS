...
import { othersSchema } from "../../utils/formSchema";
...
import { pageOthersCreate } from "../../../redux/action/paymentAction";
...
function PembayaranLainnya() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      //   console.log(values);
      dispatch(await pageOthersCreate(values, navigate, "/pembayaran-lainnya/checkout/"));
    },
...
export default PembayaranLainnya;
