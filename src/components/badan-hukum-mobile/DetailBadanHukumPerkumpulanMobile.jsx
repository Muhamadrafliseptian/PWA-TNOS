...
function DetailBadanHukumPerkumpulanMobile() {
      ...
      <div className="responsive-class">
        <div className="res-class">
          <div className="nav-top-login">
            <Link
              to="/badan-usaha-perkumpulan-m"
              className="btn nav-back-arrow"
            >
              <FaArrowLeft className="hhagwd" />
              <h5 className="title-kasnadkw">Detail Badan Usaha Perkumpulan</h5>
            </Link>
          </div>
...
export default DetailBadanHukumPerkumpulanMobile;
