...
function BadanHukumAsosiasiMobile() {
      ...
      dispatch(badanHukumCreateAction(values))
        .then(({ payload }) => {
          ...
          if (payload?.success === true) {
            ...
            navigate(`/badan-usaha-asosiasi-m/detail/` + payload?.detail?.id);
          }
        })
        .catch((error) => {
          console.log(error);
        ...
        <div className="res-class">
          <div className="nav-top-login">
            <Link to="/badan-usaha-m" className="btn nav-back-arrow">
              ...
              <h5 className="title-kasnadkw">Pembuatan Badan Hukum Asosiasi</h5>
            </Link>
          </div>
            ...
            <div className="row">
              <div className="col-lg-8 col-md-8 col-sm-8 col-xl-8 col-12">
                <p className="text-justify jjdw">
                  Buat legalitas badan Asosiasi terpercaya dan cepat dengan
...
export default BadanHukumAsosiasiMobile;
