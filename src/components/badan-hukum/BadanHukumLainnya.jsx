      ...
      dispatch(badanHukumCreateAction(values))
        .then(({ payload }) => {
          ...
          if (payload?.success === true) {
            ...
            navigate(`/badan-usaha-lainnya/` + payload?.detail?.id);
          }
        })
        .catch((error) => {
          console.log(error);
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <div className="form-check mb-2">
                ...
                <label
                  ...
                  style={{ fontSize: "13px" }}
                >
                  Saya menyatakan dengan sadar melakukan transaksi dan
                  <span
                    onClick={() =>
                      window.open(
...
export default BadanHukumLainnya;
