...
const formSchema = Yup.object({
  ...
  phone_badan_hukum: Yup.string()
    .matches(phoneRegExp, "Phone badan hukum is not valid")
...
function BadanHukumPt() {
  TitleHeader("Badan Hukum PT");
      ...
      dispatch(badanHukumCreateAction(values))
        .then(({ payload }) => {
          ...
          if (payload?.success === true) {
            ...
            navigate(`/badan-usaha-pt/` + payload?.detail?.id);
          }
        })
        .catch((error) => {
          console.log(error);
  ...
  const renderKeuntunganKlasifikasi = () => {
    ...
    } else if (formik.values.klasifikasi === "4") {
      return (
        <div className="box-layanan-sjdj">
          <b className="title-jdah">Sudah Termasuk</b>
          <ul>
            ...
            <form onSubmit={formik.handleSubmit}>
              <div className="form-group mb-2">
                ...
                >
                  ...
                  <option value="2">SCALE UP</option>
