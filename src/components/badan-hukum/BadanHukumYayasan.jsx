...
function BadanHukumYayasan() {
  TitleHeader("Badan Usaha Yayasan");
      ...
      dispatch(badanHukumCreateAction(values))
        .then(({ payload }) => {
          ...
          if (payload?.success === true) {
            ...
            navigate(`/badan-usaha-yayasan/` + payload?.detail?.id);
          }
        })
        .catch((error) => {
          console.log(error);
        ...
        <div className="res-class">
          <div className="nav-top-login">
            <Link to="/badan-usaha" className="btn nav-back-arrow">
              ...
              <h5 className="title-kasnadkw">{t("badan_hukum_yayasan")}</h5>
            </Link>
          </div>
            ...
            <div className="row">
              <div className="col-lg-8 col-md-8 col-sm-8 col-xl-8 col-12">
                <p className="text-justify jjdw">
                  Buat legalitas badan Yayasan terpercaya dan cepat dengan
              ...
              <div className="col-lg-4 col-md-4 col-sm-4 col-xl-4 col-12">
                <img src={yayasan} alt="" className="img-xy" />
              </div>
            </div>
            <hr />
            <KetentuanComponent
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <div className="form-group mb-2">
                <label htmlFor="bidang">
                  *Tujuan Bidang Usaha KBLI 2020 (Maksimal 5, dapat dilihat di
                  <a
              ...
              <div className="form-group mb-2">
                <label htmlFor="email">*Email Yayasan & Password</label>
                <input
                  name="email"
                  type="text"
...
export default BadanHukumYayasan;
