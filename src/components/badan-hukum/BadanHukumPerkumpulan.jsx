...
function BadanHukumPerkumpulan() {
  TitleHeader("Badan Hukum Perkumpulan");
      ...
      dispatch(badanHukumCreateAction(values))
        .then(({ payload }) => {
          ...
          if (payload?.success === true) {
            ...
            navigate(`/badan-hukum-perkumpulan/` + payload?.detail?.id);
          }
        })
        .catch((error) => {
          console.log(error);
...
export default BadanHukumPerkumpulan;
