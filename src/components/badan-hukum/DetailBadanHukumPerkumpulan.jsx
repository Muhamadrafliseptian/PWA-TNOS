...
function DetailBadanHukumPerkumpulan() {
  TitleHeader("Detail Badan Hukum Perkumpulan");
            ...
            <div className="nav-top-login">
              <Link to="/dashboard" className="btn nav-back-arrow">
                ...
                <h5 className="title-kasnadkw">
                  Detail Badan Hukum Perkumpulan
                </h5>
              </Link>
            </div>
...
export default DetailBadanHukumPerkumpulan;
