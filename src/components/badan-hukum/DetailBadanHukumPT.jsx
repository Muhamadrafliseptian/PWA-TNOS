...
function DetailBadanHukumPT() {
  TitleHeader("Detail Badan Hukum PT");
  ...
  const renderKlasifikasi = () => {
    if (badanHukumList?.klasifikasi === "1") {
      return "SUPER PLATINUM";
    } else if (badanHukumList?.klasifikasi === "2") {
      return "PLATINUM";
    } else if (badanHukumList?.klasifikasi === "3") {
      return "SILVER";
    } else if (badanHukumList?.klasifikasi === "4") {
      return "PERORANGAN";
    } else {
            ...
            <div className="njwdjhwk">
              ...
              <form onSubmit={formik.handleSubmit}>
                ...
                {badanHukumList?.name_badan_hukum &&
                  JSON.parse(badanHukumList?.name_badan_hukum).map(
                    (row, key) => {
                      return (
                ...
                <div className="form-group mb-2">
                  ...
                  <input
                    ...
                    type="number"
                    className={`form-control form-layanan`}
                    value={badanHukumList?.modal_dasar}
                    readOnly
                  />
                </div>
                <div className="form-group mb-2">
                  ...
                  <input
                    ...
                    type="number"
                    className={`form-control form-layanan`}
                    value={badanHukumList?.modal_disetor}
                    readOnly
                  />
                </div>
                <div className="form-group mb-2">
                  ...
                  <textarea
                    ...
                    rows="5"
                    className={`form-control form-layanan`}
                    defaultValue={badanHukumList?.pemegang_saham}
                    readOnly
                  ></textarea>
                </div>
                <div className="form-group mb-2">
...
export default DetailBadanHukumPT;
